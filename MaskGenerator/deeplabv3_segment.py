...
class Painter:
    def __init__(self):
        ...
        self.save_path = "../LidarDetector/data/kitti/training/painted_lidar_stereo_bike/"
    ...
    def run(self):
        ...
        for idx in range(num_image):
            ...
            points = self.augment_lidar_class_scores_both(scores_from_cam_r.cpu().numpy(), scores_from_cam.cpu().numpy(), points, calib_fromfile)
